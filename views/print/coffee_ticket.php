...
// COFFEE TICKET: COFFEES (24), HOT TEA'S (25), ICED DRINKS (26)
$items = $db->fetchAll("
    SELECT oi.quantity, mi.name, c.name as category_name
    FROM order_items oi
    JOIN menu_items mi ON oi.menu_item_id = mi.id
    JOIN categories c ON mi.category_id = c.id
    WHERE oi.order_id = ? AND mi.category_id IN (24, 25, 26)
...
<head>
    <meta charset="UTF-8">
    <title>COFFEE - Order #<?= htmlspecialchars($order['order_number']) ?></title>
    <style>
